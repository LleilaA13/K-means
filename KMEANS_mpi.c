...
{
	//Initialize MPI and "set it up":
	MPI_Init(&argc, &argv);
	int rank, size;
	MPI_Comm_rank(MPI_COMM_WORLD, &rank);
	MPI_Comm_size(MPI_COMM_WORLD, &size);

	//error handler to return errors instead of aborting the program
	...
	* */
	...
	//! modify lines and samples 
	//! rank 0 to read input data and distribute it among the processes
	//! modify the exits with MPI_Abort
